...
public class VirtualGardenCellInventory implements IVirtualGardenCell {
    ...
    public VirtualGardenCellInventory(ItemStack stack, @Nullable ISaveProvider host, GardenCellTier tier) {
        this.stack = stack;
        this.host = host;
        this.tier = tier;
        this.loadCellItems();
    ...
    @Nullable
    @Override
    public Item getConfiguredSeedOrSapling() {
