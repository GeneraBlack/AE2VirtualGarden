...
public class GardenDropRegistry {
    ...
    public static final TagKey<Item> CROPS_TAG = TagKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath("c", "crops"));
    public static final TagKey<Item> SEEDS_TAG = TagKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath("c", "seeds"));
    public static final TagKey<Item> SAPLINGS_TAG = TagKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath("c", "saplings"));
    public static final TagKey<Item> MUSHROOMS_TAG = TagKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath("c", "mushrooms"));
